...
}:
{
  wayland.windowManager.river = {
    ...
    extraConfig = ''
      ...
      riverctl spawn 'swaybg -o HDMI-A-1 -i ${../../wallpapers/138.png} -o DP-1 -i ${../../wallpapers/138.png}'
      ...
      riverctl spawn 'wlr-randr --output DP-1 --mode 2560x1440@144 --pos 1920,0 --output HDMI-A-1 --mode 1920x1080@60 --pos 0,0'
